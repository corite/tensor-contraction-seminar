...
\begin{frame}{Begriffseinführungen}
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.5\textwidth}
			\includegraphics[scale=.2]{figure_02_b}
		\end{column}
	\end{columns}
\end{frame}
\note[itemize]{
...
\begin{frame}{Vanilla Search - Teil 1}
	\includegraphics[scale=0.2]{algorithm_02_a}
\end{frame}
\note[itemize]{
...
\begin{frame}{Vanilla Search - Teil 2}
	\includegraphics[scale=0.25]{algorithm_02_b}
\end{frame}
\note[itemize]{
...
\begin{frame}{Vanilla Search - Teil 3}
	\includegraphics[scale=0.25]{algorithm_02_c}
\end{frame}
\note[itemize]{
